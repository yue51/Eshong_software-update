...
{
	RECORD_TYPE_NONE		= 0x00000000,		
		
		RECORD_TYPE_SENSOR	= 0x00000001,		//探头报警录像
		RECORD_TYPE_MOTION	= 0x00000002,		//移动侦测报警录像
		RECORD_TYPE_VILOST	= 0x00000004,		//视频丢失
		RECORD_TYPE_RFALM	= 0x00000008,		//RF报警联动录像
		RECORD_TYPE_NETALM	= 0x00000010,		//网络故障报警
		
		RECORD_TYPE_TIMER	= 0x00000020,		//定时录像
		RECORD_TYPE_MANUAL	= 0x00000040,		//手动录像
		
		RECORD_TYPE_PREREC	= 0x40000000,		//预录像标志位
		RECORD_TYPE_PHOTO	= 0x80000000,		//图片文件
}RECORD_TYPE;
...
typedef struct _HHFILE_INFO_EX
{
	...
	BYTE				mark;			//最后一条1,否则0
	BYTE				rsvd;		
	HH_TIME				tmStart;		//开始时间段 time_t类型
	HH_TIME				tmEnd;			//结束时间段 time_t类型
