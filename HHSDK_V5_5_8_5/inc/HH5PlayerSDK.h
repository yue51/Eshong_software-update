...
DLLEXPORT_API int __stdcall XPLAYER_InitSDK(HWND hHwnd);					//初始化SDK资源
DLLEXPORT_API int __stdcall HH5PLAYER_ReleaseSDK();							//释放  SDK资源
DLLEXPORT_API int __stdcall XPLAYER_ReleaseSDK();							//释放  SDK资源
DLLEXPORT_API int __stdcall HH5PLAYER_InitPlayer(USHORT nPort,HWND hWnd);	//初始化播放器(参见HH5PLAYER_InitPlayer2)
DLLEXPORT_API int __stdcall XPLAYER_InitPlayer(USHORT nPort,HWND hWnd);	//初始化播放器(参见HH5PLAYER_InitPlayer2)
DLLEXPORT_API int __stdcall HH5PLAYER_ReleasePlayer(USHORT nPort);			//释放播放器
DLLEXPORT_API int __stdcall XPLAYER_ReleasePlayer(USHORT nPort);			//释放播放器

//================================================================
//文件播放
//================================================================
DLLEXPORT_API int __stdcall HH5PLAYER_OpenStreamFileM(USHORT nPort,LPCTSTR filelist[], int filenum, DWORD &nTimeLength);
DLLEXPORT_API int __stdcall XPLAYER_OpenStreamFileM(USHORT nPort,LPCTSTR filelist[], int filenum, DWORD &nTimeLength);
...
DLLEXPORT_API int __stdcall XPLAYER_GetStreamFileInfo(USHORT nPort, DWORD *dwTimeLength, DWORD *dwFileLength, DWORD *dwWidth,DWORD *dwHeight);  //得到文件信息
DLLEXPORT_API int __stdcall HH5PLAYER_Play(USHORT nPort);                      //播放
DLLEXPORT_API int __stdcall XPLAYER_Play(USHORT nPort);                      //播放
DLLEXPORT_API int __stdcall HH5PLAYER_FastPlay(USHORT nPort,DWORD nValue);     //快速播放  dwValue 1---1000之间毫秒
DLLEXPORT_API int __stdcall XPLAYER_FastPlay(USHORT nPort,DWORD nValue);     //快速播放  dwValue 1---1000之间毫秒
DLLEXPORT_API int __stdcall HH5PLAYER_FastPlayBack(USHORT nPort,DWORD nValue); //块退
DLLEXPORT_API int __stdcall XPLAYER_FastPlayBack(USHORT nPort,DWORD nValue); //块退
DLLEXPORT_API int __stdcall HH5PLAYER_FrameGO(USHORT nPort);                   //单帧进
DLLEXPORT_API int __stdcall XPLAYER_FrameGO(USHORT nPort);                   //单帧进
DLLEXPORT_API int __stdcall HH5PLAYER_FrameBack(USHORT nPort);                 //单帧退
DLLEXPORT_API int __stdcall XPLAYER_FrameBack(USHORT nPort);                 //单帧退
DLLEXPORT_API int __stdcall HH5PLAYER_Pause(USHORT nPort);                     //暂停  
DLLEXPORT_API int __stdcall XPLAYER_Pause(USHORT nPort);                     //暂停  
DLLEXPORT_API int __stdcall HH5PLAYER_Resume(USHORT nPort);                    //继续
DLLEXPORT_API int __stdcall XPLAYER_Resume(USHORT nPort);                    //继续
DLLEXPORT_API int __stdcall HH5PLAYER_Stop(USHORT nPort);                      //停止
DLLEXPORT_API int __stdcall XPLAYER_Stop(USHORT nPort);                      //停止

DLLEXPORT_API int __stdcall HH5PLAYER_GetPlayPosition(USHORT nPort,DWORD *dwPlayedTime);			//得到播放的时间
DLLEXPORT_API int __stdcall XPLAYER_GetPlayPosition(USHORT nPort,DWORD *dwPlayedTime);			//得到播放的时间
DLLEXPORT_API int __stdcall HH5PLAYER_SetPlayPosition(USHORT nPort,float fOffset);					//设置播放位置
DLLEXPORT_API int __stdcall XPLAYER_SetPlayPosition(USHORT nPort,float fOffset);					//设置播放位置
DLLEXPORT_API int __stdcall HH5PLAYER_SeekToSecond(USHORT nPort,int nSec);							//移动播放指针到指定秒
DLLEXPORT_API int __stdcall XPLAYER_SeekToSecond(USHORT nPort,int nSec);							//移动播放指针到指定秒
DLLEXPORT_API int __stdcall HH5PLAYER_SetPlayLoop(USHORT nPort,bool  bIsLoop);						//循环播放 
DLLEXPORT_API int __stdcall XPLAYER_SetPlayLoop(USHORT nPort,bool  bIsLoop);						//循环播放 
...
DLLEXPORT_API int __stdcall XPLAYER_RegPlayStatusMsg(USHORT nPort, HWND hWnd, UINT MessageID);	//注册播放状态消息(1.H5PLAYER_MSG_PLAY_END:文件播放结束	2.播放进度:0 ~ 文件时间长度<秒)

//================================================================
//流播放
//================================================================
DLLEXPORT_API int __stdcall HH5PLAYER_OpenStream(USHORT nPort);
DLLEXPORT_API int __stdcall XPLAYER_OpenStream(USHORT nPort);
DLLEXPORT_API int __stdcall HH5PLAYER_PutDecStreamData(USHORT nPort,PBYTE pBuf, DWORD nSize, int nDataType);
DLLEXPORT_API int __stdcall XPLAYER_PutDecStreamData(USHORT nPort,PBYTE pBuf, DWORD nSize, int nDataType);
...
DLLEXPORT_API int __stdcall XPLAYER_PutDecStreamDataEx(USHORT nPort,PBYTE pBuf, DWORD nSize, UINT nDataType = 0x10, HH5KAV_INFO *pAVInfo = NULL);	
DLLEXPORT_API int __stdcall HH5PLAYER_StopStream(USHORT nPort);
DLLEXPORT_API int __stdcall XPLAYER_StopStream(USHORT nPort);
DLLEXPORT_API int __stdcall HH5PLAYER_CloseStream(USHORT nPort);
DLLEXPORT_API int __stdcall XPLAYER_CloseStream(USHORT nPort);
DLLEXPORT_API int __stdcall HH5PLAYER_GetStreamFrameSize(USHORT nPort);
DLLEXPORT_API int __stdcall XPLAYER_GetStreamFrameSize(USHORT nPort);
DLLEXPORT_API int __stdcall HH5PLAYER_GetAudioFrameSize(USHORT nPort);
DLLEXPORT_API int __stdcall XPLAYER_GetAudioFrameSize(USHORT nPort);
DLLEXPORT_API int __stdcall HH5PLAYER_SetStreamPlaySpeed(USHORT nPort, USHORT nSpeed);
DLLEXPORT_API int __stdcall XPLAYER_SetStreamPlaySpeed(USHORT nPort, USHORT nSpeed);
DLLEXPORT_API int __stdcall HH5PLAYER_GetStreamPlaySpeed(USHORT nPort);
DLLEXPORT_API int __stdcall XPLAYER_GetStreamPlaySpeed(USHORT nPort);
...
DLLEXPORT_API int __stdcall XPLAYER_SetStreamPlaySpeed2(USHORT nPort,float fValue,bool bDelayAdjust = true);

//================================================================
//其它
//================================================================
DLLEXPORT_API int __stdcall HH5PLAYER_SetAudio(USHORT nPort,bool bEnabled);         //设置音频
DLLEXPORT_API int __stdcall XPLAYER_SetAudio(USHORT nPort,bool bEnabled);         //设置音频
DLLEXPORT_API int __stdcall HH5PLAYER_UpDateImage(USHORT nPort);					//刷新图象
DLLEXPORT_API int __stdcall XPLAYER_UpDateImage(USHORT nPort);					//刷新图象
DLLEXPORT_API int __stdcall HH5PLAYER_UpdateBounds(USHORT nPort);					//刷新显示窗口边界  
DLLEXPORT_API int __stdcall XPLAYER_UpdateBounds(USHORT nPort);					//刷新显示窗口边界  
DLLEXPORT_API int __stdcall HH5PLAYER_SetDisplayhWnd(USHORT nPort,HWND hWnd);		//设置显示窗口
DLLEXPORT_API int __stdcall XPLAYER_SetDisplayhWnd(USHORT nPort,HWND hWnd);		//设置显示窗口
DLLEXPORT_API int __stdcall HH5PLAYER_SetPartDisplay(USHORT nPort,HWND hPartWnd,RECT *pPartRect);	//局部放大显示
DLLEXPORT_API int __stdcall XPLAYER_SetPartDisplay(USHORT nPort,HWND hPartWnd,RECT *pPartRect);	//局部放大显示
DLLEXPORT_API int __stdcall HH5PLAYER_CaptureOnePicture(USHORT nPort,void **bmpbuf,int &bmpsize);	//捕捉当前的图像
DLLEXPORT_API int __stdcall XPLAYER_CaptureOnePicture(USHORT nPort,void **bmpbuf,int &bmpsize);	//捕捉当前的图像

DLLEXPORT_API int __stdcall HH5PLAYER_GetVolume(USHORT nPort, long *lpVolume);		//设置音量
DLLEXPORT_API int __stdcall XPLAYER_GetVolume(USHORT nPort, long *lpVolume);		//设置音量
DLLEXPORT_API int __stdcall HH5PLAYER_SetVolume(USHORT nPort, long lVolume);		//获取音量
DLLEXPORT_API int __stdcall XPLAYER_SetVolume(USHORT nPort, long lVolume);		//获取音量

DLLEXPORT_API int __stdcall HH5PLAYER_SetDecoderQulity(bool bQulity);				//0: 高质量  1: 低质量
DLLEXPORT_API int __stdcall XPLAYER_SetDecoderQulity(bool bQulity);				//0: 高质量  1: 低质量
DLLEXPORT_API int __stdcall HH5PLAYER_SetDecoderParam(bool bZoomIn, bool bDeInterlace, bool bPlayMode = FALSE);		//bZoomIn:		大画面显示
DLLEXPORT_API int __stdcall XPLAYER_SetDecoderParam(bool bZoomIn, bool bDeInterlace, bool bPlayMode = FALSE);		//bZoomIn:		大画面显示
																													//bDeInterlace:	消隔行锯齿
...
DLLEXPORT_API int __stdcall XPLAYER_SetVideoBufferSize(int nFrameNum = 15);		//当流畅性优先时，缓存的帧数(1 ~ 60)
...
DLLEXPORT_API int __stdcall XPLAYER_ClearAllBuffer(USHORT nPort);										
DLLEXPORT_API int __stdcall XPLAYER_ClearVideoBuffer(USHORT nPort);		
DLLEXPORT_API int __stdcall XPLAYER_ClearAudioBuffer(USHORT nPort);		
DLLEXPORT_API int __stdcall XPLAYER_ClearImage(USHORT nPort, DWORD dwColor = 0);	//清除DirctX表面
...
DLLEXPORT_API int   __stdcall XPLAYER_AudioEncodeData(unsigned short *BuffIn,   int InNum, BYTE *BuffOut);
DLLEXPORT_API int   __stdcall XPLAYER_AudioDecodeData(BYTE *BuffIn,  int InNum, unsigned short  *BuffOut);
...
DLLEXPORT_API int   __stdcall XPLAYER_G726AEncodeData(unsigned short *BuffIn,   int InNum, BYTE *BuffOut);
DLLEXPORT_API int   __stdcall XPLAYER_G726ADecodeData(BYTE *BuffIn,  int InNum, unsigned short  *BuffOut);
...
DLLEXPORT_API int   __stdcall XPLAYER_AudioEncodeDataEx(unsigned short *BuffIn,   int InNum, BYTE *BuffOut, UINT nEncodeType, UINT nBitrate);
DLLEXPORT_API int   __stdcall XPLAYER_AudioDecodeDataEx(BYTE *BuffIn,  int InNum, unsigned short  *BuffOut, UINT nEncodeType, UINT nBitrate);
...
DLLEXPORT_API int   __stdcall XPLAYER_SelectH264(USHORT nPort,UINT nVersion);				//nVersion 1:old(123),2:new(125)
DLLEXPORT_API int   __stdcall XPLAYER_WaitForVerticalBlank(bool bWait = false);			//抗裂痕功能开关 false: 关  true: 开
...
DLLEXPORT_API int   __stdcall XPLAYER_InitPlayer2(USHORT nPort,HWND hWnd,bool bSupportDraw = false);
DLLEXPORT_API int   __stdcall XPLAYER_DrawImage( USHORT nPort,int x,int y,unsigned char *pBmpImage,int nSize);
DLLEXPORT_API int   __stdcall XPLAYER_DrawText(  USHORT nPort,int x,int y,char *pszText,LOGFONT ft,COLORREF crText,COLORREF crBack = -1/*crBack -1: 透明*/);
DLLEXPORT_API int   __stdcall XPLAYER_SetDrawPen(USHORT nPort,int nPenStyle,int nWidth, COLORREF crColor);
DLLEXPORT_API int   __stdcall XPLAYER_DrawLine(  USHORT nPort,int x1,int y1,int x2,int y2);
DLLEXPORT_API int   __stdcall XPLAYER_DrawRect(  USHORT nPort,int x1,int y1,int x2,int y2);
DLLEXPORT_API int   __stdcall XPLAYER_ClearDraw( USHORT nPort,int nType);					//nType: 0 all, 1 image, 2 text, 3 line, rect
...
DLLEXPORT_API int   __stdcall XPLAYER_RegCBOnDraw(USHORT nPort, HHCBOnDraw pCBOnDraw, void *pContext = NULL);

//================================================================================
//新增函数3: 对讲typedef int (WINAPI *HHTalkCaptureData)(BYTE *pBuffer, int nBufLen, DWORD dwContext = 0, void *pContext = NULL);
//================================================================================
...
DLLEXPORT_API int __stdcall XPLAYER_TKInit(  HWND hWnd, HANDLE &hTalk);
DLLEXPORT_API int __stdcall XPLAYER_TKRegCaptureDataCB(HANDLE hTalk,HHTalkCaptureData pCBTalk,DWORD dwContext = 0,void *pContext = NULL);
...
DLLEXPORT_API int __stdcall XPLAYER_TKStart( HANDLE hTalk,WAVEFORMATEX *pInFormat, WAVEFORMATEX *pOutFormat);  
DLLEXPORT_API int __stdcall XPLAYER_TKStop(  HANDLE hTalk); 
...
DLLEXPORT_API int __stdcall XPLAYER_TKSendToPCData(HANDLE hTalk, BYTE *pBuffer,int nBufLen);
DLLEXPORT_API int __stdcall XPLAYER_TKSetVolume(   HANDLE hTalk, long lVolume);	
DLLEXPORT_API int __stdcall XPLAYER_TKGetVolume(   HANDLE hTalk, long *lpVolume);

DLLEXPORT_API int __stdcall HH5PLAYER_TKRelease(HANDLE hTalk);
DLLEXPORT_API int __stdcall XPLAYER_TKRelease(HANDLE hTalk);
...
DLLEXPORT_API int __stdcall XPLAYER_RegYUVDataCallBack(YUVDataCallBack pYUVDataCallBack, bool nDispImage);
...
int __stdcall XPLAYER_RegVideoBufCallBack(USHORT nPort, DWORD nThreShold, HHVideoBufCallBack pVideoBufCallBack, void *pContext = NULL);
int __stdcall XPLAYER_ResetVideoBufFlag(USHORT nPort);
...
DWORD __stdcall XPLAYER_GetSdkVersion();
DWORD __stdcall XPLAYER_GetCaps();
int   __stdcall XPLAYER_GetPlayer();
int   __stdcall XPLAYER_SetStreamPlayMode(USHORT nPort, DWORD nMode, DWORD nThreShold);
int   __stdcall XPLAYER_GetStreamPlayMode(USHORT nPort);

//====================================================
//6.2.9新增函数：刷新画面（显示最后一幅图像）
//====================================================
int __stdcall HH5PLAYER_RefreshPlay(USHORT nPort);
int __stdcall XPLAYER_RefreshPlay(USHORT nPort);
...
DLLEXPORT_API int __stdcall XPLAYER_SetDisplayGUID(char *pGuid);				
DLLEXPORT_API int __stdcall XPLAYER_SetDisplayGUIDEx(USHORT nPort, char *pGuid);
DLLEXPORT_API int __stdcall XPLAYER_SetDisplayWndEx(USHORT nPort,  unsigned int nFirstScreenWidth);
...
DLLEXPORT_API int __stdcall XPLAYER_RegDrawImageCallBack(DrawImageCallBack pDrawImageCallBack);
